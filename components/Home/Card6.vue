<template>
  <div class="w-full pp-box flex h-420px items-center justify-between">
      <div class="left_box">
        <img src="~/assets/images/logo.png" class="w-136px"/>
        <p class="text-[#333333] text-51px font-semibold mt-21px">{{$t('在社交网络上关注我们')}}</p>
