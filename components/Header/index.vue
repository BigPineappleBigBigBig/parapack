<template>
  <div id='header'  class="sticky bg-white top-0 z-999 h-[140px] w-full">
    <div class='max-w-2560px w-full h-full m-auto flex items-center justify-between px-40px gap-x-40px pp-text-t2'>
      <LogoIcon></LogoIcon>
