...
export default defineConfig({
  ...
  theme: {
    fontFamily: {
      sans: ['SFEIBMPlexSans', '-apple-system', 'BlinkMacSystemFont', 'Roboto', 'Arial', 'sans-serif'],
      serif: ['SFEIBMPlexSans', '-apple-system', 'BlinkMacSystemFont', 'Roboto', 'Arial', 'sans-serif'],
      Gilroy: ['Gilroy', '-apple-system', 'BlinkMacSystemFont', 'Roboto', 'Arial', 'sans-serif']
    },
    fontSize: {
      sm: '0.8rem',
      base: '1rem',
  ...
  shortcuts: {
    ...
    ...text,
    ...button,
    'ubox-scrollbar': 'scrollbar-thin scrollbar-track-dark-0 scrollbar-thumb-neutral-600 scrollbar-corner-dark-0',
  },
  extract: {
